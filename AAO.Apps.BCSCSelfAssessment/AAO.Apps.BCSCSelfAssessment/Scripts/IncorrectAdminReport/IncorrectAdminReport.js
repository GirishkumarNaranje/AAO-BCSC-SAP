...
$(document).ready(function () {
    ...
    function reloadAssessment(PageNo) {
        ...
        var pgyYear = IncorrectDetails.Year;
        var ExamStartDate = IncorrectDetails.ExamStartDate;
        var ExamCompletedDate = IncorrectDetails.ExamCompletedDate;
    
        window.location.href = '/IncorrectAdminReport/AdminIncorrectQuestionDetails' + '?year=' + pgyYear + '&SubspecialtyId=' + SubSpecialityId + '&ExamStartDate=' + ExamStartDate + '&ExamCompletedDate=' + ExamCompletedDate+'&NoOfRecords='+QuestionViewVal+'&PageNo='+PageNo;
    }
